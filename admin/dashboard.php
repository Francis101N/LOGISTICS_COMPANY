        ...
        <header class="topbar bg-danger" data-navbarbg="skin5">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse bg-danger" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <!-- ============================================================== -->
                    <ul class="navbar-nav ms-auto d-flex align-items-center bg-danger">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Total Shipments/Deliveries</h3>
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                <li>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="white-box">
                            <h3 class="box-title">Yearly Logistics Services Summary</h3>
                            <div class="d-md-flex">
