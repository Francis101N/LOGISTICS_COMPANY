                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="myfields">
                                        ...
                                        <input type="text" name="tracking_no" value="<?php echo $row['Tracking_no']; ?>" class="form-control"><br>
                                       ...
                                       <input type="text" name="fullnames" value="<?php echo $row['R_fullname']; ?>" class="form-control">
                                        ...
                                        <input type="text" name="pickup_location" value="<?php echo $row['Pickup_location']; ?>" class="form-control"><br>
                                        ...
                                        <label>Status</label>
                                        <input type="text" name="status" value="<?php echo $row['Status']; ?>" class="form-control"><br>
